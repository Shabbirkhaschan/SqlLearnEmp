...
OSSController objController;
    ...
    private void PopulateDataFromDatabase(ArrayList<EmployeeDTO> list) {
        ...
        try {
            ...
            dtm.addColumn("Title");
            dtm.addColumn("TitleOfCoutesy");
            dtm.addColumn("birthDate");
            dtm.addColumn("HireDate");
            dtm.addColumn("Phone");
            dtm.addColumn("PostalCode");
             dtm.addColumn("PhotoPath");
            ...
            for(EmployeeDTO emp : list)
            {
                ...
                rowData[0] = emp.Id;
                rowData[1] = emp.FirstName;
                rowData[2] = emp.LastName;
                rowData[3] = emp.Address;
                rowData[4] = emp.Title;
                rowData[5] = emp.TitleOfCourtesy;
                rowData[6] = emp.BirthDate;
                rowData[7] = emp.HireDate;
                rowData[8] = emp.Phone;
                rowData[9] = emp.PostalCode;
                 rowData[10] = emp.PhotoPath;
